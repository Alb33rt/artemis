...
class CarbonEntry(models.Model):
    item_involved = models.ForeignKey(Item, on_delete=models.CASCADE, related_name="CarbonEntry")
    owner = models.ForeignKey(User, on_delete=models.CASCADE, related_name="CarbonEntry")
